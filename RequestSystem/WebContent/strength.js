			...
			init: function() {
				...
				function get_total(total,thisid){
					...
					if(total == 0){
						...
						thismeter.removeClass();
						thismeter.addClass('strong').html('<p class="isStrong">Strength: strong</p>');
					}
				}
				...
				.after('<div id="'+this.options.strengthMeterClass+'" class="'+this.options.strengthMeterClass+'"><div data-meter="'+thisid+'"><p></p></div></div>');
